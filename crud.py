...
def create_melon(melon_name, melon_cost, melon_picture):
    """Create and return a new melon."""
    melon = Melon(melon_name = melon_name, melon_cost=melon_cost, melon_picture=melon_picture)
    return melon
...
def create_tasting(tasting_name, tasting_picture):
    """Create and return a new tasting."""
    tasting = Tasting(tasting_name = tasting_name, tasting_picture=tasting_picture)
    return tasting
